package com.example.campingwithcompose.core.ui.navigation.component.phonenumbercomponet.component
...
import com.example.campingwithcompose.core.ui.navigation.component.phonenumbercomponet.data.Iso31661alpha2
import com.example.campingwithcompose.core.ui.navigation.component.phonenumbercomponet.data.PhoneCode
import com.example.campingwithcompose.core.ui.navigation.component.phonenumbercomponet.data.utils.ValidatePhoneNumber
import com.example.ccp.data.utils.extractCountryCode
import com.example.ccp.data.utils.getCountryFromPhoneCode
import com.example.ccp.data.utils.getUserIsoCode
import com.example.ccp.data.utils.numberHint
import com.example.campingwithcompose.core.ui.navigation.component.phonenumbercomponet.transformation.PhoneNumberTransformation
import com.example.ccp.component.autofill
        ...
        leadingIcon = {
            TogiCodeDialog(
                ...
                backgroundColor = MaterialTheme.colorScheme.background.let { color ->
                    when (color) {
                        Color.Unspecified, Color.Transparent -> MaterialTheme.colorScheme.surface
                        else -> color
                    }
                }
            )
